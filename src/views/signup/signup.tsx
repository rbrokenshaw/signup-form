...
const SignUp = () => {
    return (
        <main className='main-bg min-h-screen bg-cover bg-customRed flex desktop:items-center justify-center'>
            <div className='w-full max-w-3xl desktop:max-w-full p-7 pt-[50px] pb-20 desktop:p-10 border-box flex flex-col justify-center desktop:flex-row desktop:w-5/6 gap-10'>
                <Hero />
